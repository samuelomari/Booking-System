  ...
  return (
    <div className='min-h-screen bg-slate-900 flex items-center justify-center px-4'>
      <div className='w-full max-w-md bg-slate-800 rounded-3xl border border-slate-700 shadow-2xl p-8'>
        ...
        {resetSent && (
          <p className='mt-4 text-center text-sm text-green-400'>Password reset email sent!</p>
        )}

        <div className='mt-3 text-center'>
          <button onClick={handleReset} className='text-sm text-slate-400 hover:text-indigo-400 transition'>
            Forgot password?
          </button>
        </div>
